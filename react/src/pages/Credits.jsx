...
useEffect(() => {
  ...
  // payment success ke baad auto refresh
...
if(loading) return <Loading/>
 ...
 return (
    <div className=' mx-w-7xl h-screen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12'>
    <h2 className='text-3xl font-semibold text-center mb-10 xl:mt-30 
     ...
     <div className='flex flex-wrap justify-center gap-8'>
      {plans.map((plan)=>(
        ...
        shadow hover:shadow-lg transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ?
